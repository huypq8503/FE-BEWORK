import { Button, Result, Skeleton, Table, Tag, Modal, message, Checkbox, Input, Image } from 'antd';
...
const PostManage = () => {
    ...
    const handleUpdateStatus = (jobPostId: number | string, currentStatus: number) => {
        ...
        if (currentStatus === 0) {
            ...
            setSelectedJobPost({ id: jobPostId, status: newStatus, assess_admin: 'default_value' });
        } else {
            updateStatus({ id: jobPostId, status: newStatus, assess_admin: 'default_value' }).unwrap();
