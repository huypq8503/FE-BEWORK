    ...
    return (
        <div>
            ...
            <Modal
                ...
                okType="default"
                onOk={() => handleModalConfirm(2)} // Duyệt (Trạng thái 1)
                onCancel={() => handleModalConfirm(1)} // Không duyệt (Trạng thái 0)
                okButtonProps={{ style: { backgroundColor: '#fff2e8', color: '#d4380d', border: '1px solid #ffbb96' } }}
                cancelButtonProps={{ style: { backgroundColor: '#f6ffed', color: '#389e0d', border: '1px solid #b7eb8f' } }}
            >
            </Modal>
            <Modal
            ...
            >
                {data?.data
                    ?.filter((item: ICompanys | { id: null }) => item.id === selectedPostId)
                    .map((item: ICompanys) => {
                        return (
                            <div key={item.id}>
                                        ...
                                        <div className="grid grid-cols-2 border text-[15px]">
                                            ...
                                            <div className="grid grid-cols-1 gap-2 py-2">
                                                ...
                                                <div className="grid grid-cols-12 items-center gap-2 border-b pb-2">
                                                    ...
                                                    <p className="col-span-7">{String(item.founded_in)}</p>
                                                </div>
                                                <div className="grid grid-cols-12 items-center gap-2">
