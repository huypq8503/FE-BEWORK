...
import { useFindJobsMutation, useGetInfoFindJobQuery, useGetInfoUserQuery } from '../../../api/find-Job/find_jobApi';
                ...
                <div className='sticky top-0'>
                    <div className='shadow-sm shadow-blue-300 px-6'>
                        <div className='flex justify-between'>
                            <div className='w-28'>
                                {listImage ? (
                                    <img src={candidateData?.candidate?.image} alt="" className='h-28 w-28 rounded-full' />
                                ) : (
