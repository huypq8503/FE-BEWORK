...
const TabsOverview = React.memo(() => {
    ...
    function truncateString(str: string | undefined, maxLength: number): string {
        ...
        return str || ''; // Trả về chuỗi ban đầu nếu nó không quá dài, hoặc chuỗi rỗng nếu nó là null hoặc undefined
    }
        ...
        <div>
            <div className='grid grid-cols-2 gap-8 text-gray-700'>
                ...
                <div className='grid grid-cols-3 gap-6 h-60'>
                    ...
                    <div className='border border-gray-300 rounded-lg p-3 text-center'>
                        <a href={listCompanyDetail?.link_web} target="_blank" rel="noopener noreferrer" className='font-semibold h-[63px] block'>
                            {truncateString(listCompanyDetail?.link_web, 15)}
                        </a>
                        <p>Website</p>
                    </div>
