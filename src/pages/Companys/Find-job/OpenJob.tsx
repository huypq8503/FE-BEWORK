...
import { useCancelSaveProfileMutation, useGetFindCandidateByIdQuery, useGetProfileOpenQuery, useOpenProfileMutation, useRateProfileMutation, useSaveProfileMutation } from "../../../api/companies/findJob";
                                ...
                                <div className="leading-8 border-b pb-2">
                                    ...
                                    <p className="flex items-center"><span className="w-28">Mức lương:</span>
                                        <span>{item.desired_salary === null ? (
                                            ...
                                            <p className="text-red-500">{formatCurrency(Number(item.desired_salary), 'VND')}</p>
                                        )}</span></p>
                                </div>
